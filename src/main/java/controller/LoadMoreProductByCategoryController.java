...
@WebServlet(urlPatterns = {"/loadPC"})
public class LoadMoreProductByCategoryController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String imgUrl = "";
		List<Product> listP = productDao.getLoadNextProductByCategory(cateId, amount);
		...
		for(Product o: listP) {
			...
			if(o.getpImage().contains("https")) {
				out.println("<div class=\"col l-2-4 lo-3 m-4 c-6 search-item-result__item\">\r\n"
					...
					+ "											</div>\r\n"										
					+ "											<div class=\"search-item-result__item-overlay\">\r\n"
					+ "												<img src=\""+o.getpImage()+"\" alt=\" "+o.getpName()+"\">\r\n"
					+ "											</div>\r\n"
					+ "										</div>\r\n"
					+ "										<div class=\"search-item-result__item-body\">\r\n"
					+ "											<div class=\"search-item-result__item-group\">\r\n"
				...
				out.println("<div class=\"col l-2-4 lo-3 m-4 c-6 search-item-result__item\">\r\n"
						...
						+ "											</div>\r\n"										
						+ "											<div class=\"search-item-result__item-overlay\">\r\n"
						+ "												<img src=\"http://localhost:8080/Shopee/image?fname="+o.getpImage()+"\" alt=\" "+o.getpName()+"\">\r\n"
						+ "											</div>\r\n"
						+ "										</div>\r\n"
						+ "										<div class=\"search-item-result__item-body\">\r\n"
						+ "											<div class=\"search-item-result__item-group\">\r\n"
