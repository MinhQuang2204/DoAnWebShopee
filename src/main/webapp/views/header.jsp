                ...
                <div class="row sm-gutter">
                    <div class="col l-12 m-12 c-12">
                                ...
                                <li class="navbar__item navbarItem__QR-show">
                                    <div class="wrap">
                                        ...
                                        <div class="navbarItem__QR">
                                            <img src="<c:url value="/img/QR_code.png"/>" alt="QR Code"
                                                class="navbarItem__QR-img">
                                            <div class="navbarItem__QR-apps">
                                                <a href="">
                                                    <img src="<c:url value="/img/app_store.png"/>" alt="App Store"
                                                        class="navbarItem__QR-app">
                                                </a>
                                                <a href="" class="">
                                                    <img src="<c:url value="/img/GooglePlay.png"/>" alt="Google Play"
                                                        class="navbarItem__QR-app">
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <li class="navbar__item border-none">
                            <a href="/Shopee/login" class="navbar__item-link medium-text">
                                Đăng Nhập
                            </a>
                        </li> 
                    </c:if>
                                <li class="navbar__item border-none">
                                    ...
                                    <c:if test="${not empty sessionScope.acc.uImage}">
                                        ...
                                        <ul class="navbarItem__user-list">
                                            ...
                                            <li class="navbarItem__user-item">
                                                <a href="/Shopee/logout" class="navbarItem__user-link">
                                                    Đăng Xuất
                                                </a>
                                            </li>
                                        </ul>
