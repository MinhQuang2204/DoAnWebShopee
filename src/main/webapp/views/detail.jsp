                        ...
                        <article class="card-body ">
                            ...
                            <p class="price-detail-wrap">
                                <span class="price h3 text-warning"> <span
                                    class="currency"></span><span class="num"><fmt:formatNumber
														type="number" pattern="#,###"
														value="${p.pPrice}"></fmt:formatNumber>₫</span>
                                </span>
                                <!--<span>/per kg</span>-->
                            </p>
                            <!-- price-detail-wrap .// -->
                    ...
                    <div class="col  m-12 c-12">
                        ...
                        <div class="row sm-gutter search-item-result__items">
                            ...
                            <div class="col l-2-4 lo-3 m-4 c-6 search-item-result__item">
                                <a href="/Shopee/product/detail?pId=${o.pId}&quantity=1&action=" class="search-item-result__item-link">
                                        ...
                                        <div class="search-item-result__item-price-wrap">
                                            ...
                                            <div class="search-item-result__item-price-saleoff">
                                                <span>
                                                    <fmt:formatNumber
														type="number" pattern="#,###"
														value="${o.pPrice}"></fmt:formatNumber>
                                                </span>
